		 ...
		 -->	
			...
			<li iconCls="icon-user"><span>销售管理</span>
				<ul>
					...
					<li><span><a href="javascript:void(0)"
							onclick="addPanel('./edg_shth/sdemo.html','售后退回')">售后退回</a></span></li>
					<li><span><a href="javascript:void(0)"
							onclick="addPanel('./edg_thjl/sdemo.html','退回记录')">退回记录</a></span></li>
			...
			<li iconCls="icon-manager"><span>系统管理</span>
				<ul>
					...
					<li><span><a href="javascript:void(0)"
							onclick="addPanel('./xtgl/rzgl.html','日志管理')">日志管理</a></span></li>
				</ul>			
		</ul>
	</div>
